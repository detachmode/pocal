...
namespace Pocal
{
    public static class ViewSwitcher
    {
        ...
        private static void openSDV(MainPage mainpage)
        {
            ...
            CompositeTransform transform = mainpage.SingleDayView.RenderTransform as CompositeTransform;
            transform.TranslateY = 0;
            mainpage.SingleDayView.RenderTransform = transform;
            mainpage.SingleDayView.Opacity = 1.0;
